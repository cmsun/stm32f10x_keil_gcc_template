...
extern void TIM3_PWM_DefPin_Init(Sm::PWM_Chl);
extern void TIM3_PWM_PartialRemap_Init(Sm::PWM_Chl);
extern void TIM3_PWM_FullRemap_Init(Sm::PWM_Chl);
...
typedef Sm_TIM<TIM3_BASE,
        ...
        TIM3_IRQn,
        &TIM3_Callback,
        &TIM3_CbArg> Sm_TIM3_PartialRemap;
